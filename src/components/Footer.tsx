...
export default function Footer() {
  return (
    <footer className="bg-veryDarkBlue py-10 px-6 flex flex-col items-center md:flex-row md:gap-6">
      ...
      <ul className="flex flex-col items-center gap-6 my-10 md:flex-row flex-grow">
        <li>
          <a href="#" className="text-white uppercase hover:brightness-75">
            Features
          </a>
        </li>
        <li>
